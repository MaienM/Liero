...
import com.lierojava.client.render.FontRenderProxy;
...
public class HUD {	
	...
	public ArrayList<RenderProxy> render() {
		...
		for (Player player : GlobalState.currentGame.players) {
			...
			// Player name.
			proxies.add(new FontRenderProxy(player.data.name, "font-hud-playername", new Vector2(playerPosition.x, playerPosition.y + 36), true));
